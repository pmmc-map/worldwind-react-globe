...
const CLICK_MODE_DROP = 0;
const CLICK_MODE_PICK = 1;
...
export default class Globe extends Component {
  constructor(props) {
	...
	// differentiate between when we are selecting or dropping something
	this.clickMode = CLICK_MODE_PICK;
